...
class Template307081BufrWeatherReport extends BaseBufrWeatherReport
{
    ...
    public function prepareSection3()
	{
        ...
        $this->report_parts[$s][$i] = '1100011101010001';
        $this->explanations[$s][$i][] = 'Octets 8-9: <span>'.$this->report_parts[$s][$i].'</span> => <span>Template 3 07 081</span> (16 bits)';   
    }
    ...
    public function prepareSection4()
	{
        ...
        if (isset($this->sensors['rain_in_period']))
		{
			...
			else 
			{
				...
				$rain_last_24_hr = $handler_obj->getTotalInLastXHr($this->sensors['rain_in_period']['sensor_feature_id'], $script_runtime, $rain_total_hours, false);
        ...
        if (isset($this->sensors['wind_direction_1']))
		{
			...
			else
			{
                ...
                $handler_obj = SensorHandler::create($this->sensors['wind_direction_1']['handler_id_code']);
				
				// apply magnetic north offset
                $tmp = $handler_obj->applyOffset($this->sensors['wind_direction_1']['sensor_feature_value'], $this->station_info->magnetic_north_offset);            
		...
		// 12 bits. Metric = hour. Scale = 0. Ref = -2048.
        $this->report_parts[$s][$i] = $this->prepare_binary_value(2024, 12);
