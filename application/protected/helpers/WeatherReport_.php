...
class WeatherReport extends BaseComponent
{
    ...
    protected function _init()
	{
        ...
        if (!$this->_prepareListenerLogInfo()) {
            return false;
        }
...
//				$this->schedule_process_info->save();
    ...
    public function prepareSensorsInfo($listener_log_id)
	{
		...
		$this->_logger->log(__METHOD__." this->schedule_process_info->ScheduleReportToStation->realStation->station_id "
            .$this->schedule_process_info->ScheduleReportToStation->realStation->station_id);
