<?php
/**
 * @var array|RefbookMeasurementType[] $meas_types
 */
$this->renderPartial('../_tmpls/admin_setup_submenu', array(), false, true );
?>
<div class="middlenarrow">
<h1><?php echo It::t('menu_label', 'admin_setup_coefficients')?></h1>
...
<?php } else {?>
    ...
    <?php echo  CHtml::beginForm($this->createUrl('admin/coefficients'), 'post'); ?>
