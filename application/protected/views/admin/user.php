...
<div class="middlenarrow">
    ...
    <?php echo CHtml::beginForm($this->createUrl('admin/user'), 'post'); ?>
    ...
    <table class="formtable" style="float: left; width: 550px;" >
        ...
        <tr>
            ...
            <td colspan="3">
                <?php echo CHtml::activeDropDownList($user, 'role', array_slice(Yii::app()->params['user_role'],1), array('style' => 'width: 270px;')); ?>
            </td>
        </tr>
        <tr>
